...
<button onClick={() => { scrollToSection('contact'); setMobileOpen(false); }}
      ...
      {/* HOME */}
      <section id="home" className="relative min-h-[calc(100vh-60px)] flex items-center py-10 sm:py-14 px-4 overflow-hidden scroll-mt-16">
        ...
        <div className="relative max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <h1 className="text-white mb-4 sm:mb-5" style={{ fontSize: 'clamp(2rem, 8vw, 4.5rem)', fontWeight: 700, letterSpacing: '-0.01em', lineHeight: 1.05, fontFamily: 'Montserrat, sans-serif' }}>
                Stop Knowing,{' '}
